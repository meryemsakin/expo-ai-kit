...
final class VisionClient {
  ...
  func availability() -> [String: Any] {
    return [
      ...
      "faceDetection": imageLabelingAvailability,
    ]
  }
  ...
  func requireFeatures(_ features: [String]) throws {
    ...
    if features.contains("face-detection") && Self.isSimulator {
      throw contractError("DEVICE_NOT_SUPPORTED", "Face detection requires a physical iOS device")
    }
  }
